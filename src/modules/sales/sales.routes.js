...
const {createSaleHandler,validateSaleHandler, getTodaySalesHandler, getSaleByIdHandler, getSaleByInvoiceHandler, cancelSaleHandler, returnSaleHandler, getSalesByDateRangeHandler} = require("../sales/sales.controller");
...
salesRouter.post("/validate", validateSaleHandler);
salesRouter.post("/create", createSaleHandler);
/*
